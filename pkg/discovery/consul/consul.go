...
// Registry defines Consul Registry

// Registry defines a Consul service registry
...
// Register registers an instance with the Consul Service
func (r *Registry) Register(ctx context.Context, instanceID, serviceName string, hostPort string) error {
...
// ReportHealthyState reports state :0
